        ...
        //Notification Area
            //Notification Items
                public function getAdminNotification(Request $req){
                    ...
                    ->join('trackings as t','t.id','=','an.trackings_id')
        ...
        //Pending Area
            //get pending returned Items Data
                public function getReturnedItemsData(Request $req){
                    ...
                    ->select('t.abbr as type','i.article as brand','i.property_no','ia.price as acquisition','uri.defect','u.firstname','u.surname','uri.uri_id')
