            ...
            <div className="z-50 w-full h-full bg-neutral-800 bg-opacity-75 fixed top-0 right-0 flex justify-center items-center">
                <div ref={modalBody} className="bg-white max-w-[550px] p-8 space-y-6 rounded-2xl text-center flex flex-col items-left">
                    ...
                    <div className="flex gap-4 items-center justify-center">
                        <div onClick={() => props.clickAlert(false,props.destination,'none')} className="btn-color-3 dark:text-white hover:bg-neutral-200 dark:hover:bg-lightColor-600 rounded-full px-5 py-3 cursor-pointer">
                            {props.alertNoButton}
                        </div>
                        
                        {/* Red Button */}
                        <div className={props.alertButtonColor === "red" ? "" : "hidden"}>
                            <div onClick={() => props.clickAlert(false,props.destination,props.accept)} className="bg-red-600 hover:bg-red-700 text-white rounded-full px-5 py-3 cursor-pointer font-semibold">
                        ...
                        <div className={props.  alertButtonColor === "blue" ? "" : "hidden"}>
                            <div onClick={() => props.clickAlert(false,props.destination,props.accept)} className="bg-primary text-white rounded-full px-5 py-3 cursor-pointer font-semibold">
                                {props.alertYesButton}
                            </div>
                        </div>
                        {/* Red Button */}
