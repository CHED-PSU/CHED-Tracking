...
export default function RequistionItems(props) {
    ...
    return (
        <div className="flex flex-row w-full 2xl:p-5 xl:p-3 p-3 2xl:gap-4 xl:gap-3 gap-3 rounded-lg text-[#6C6C6C] border border-[#DDDDDD] dark:border-[#434343] bg-white dark:bg-darkColor-800">
