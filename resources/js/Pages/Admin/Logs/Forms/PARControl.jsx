                    ...
                    <div className="flex justify-between py-5 mb-5 mx-10 border-b-2">
                        <div className="w-1/2">
                            ...
                            <div className="text-left cursor-defaul">
                                <h4 className="text-primary dark:text-white text-2xl font-semibold">PAR Control</h4>
                            ...
                            <table id="items" className="table-auto custom-t w-full min-w-[700px]">
                                <thead>
                                    <tr
                                        ...
                                        <th className="h-10 2xl:w-40 xl:w-10 w-10 font-medium text-left pl-6">PAR No.</th>
                                        ...
                                        <th className="h-10 2xl:w-40 xl:w-10 w-10 font-medium text-left px-3">Remarks/Transfered</th>
