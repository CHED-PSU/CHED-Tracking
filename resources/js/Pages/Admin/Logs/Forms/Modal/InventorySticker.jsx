...
export default function InventorySticker(props) {
    ...
    const icsItemsMapper = (items) => {
        return items?.map((data) => {
            return (
                <tr key={data.uri_id} className="avoid text-xs h-fit
        ...
        return (
            <>
                {[...Array(times)].map((_, index) => (
                    <div key={index} className="flex-none border-2 border-black w-[2.9in] avoid">
                            ...
                            <table className="text-[5px]">
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="text-[8px] font-semibold">: TABLE</td>
                                    </tr>
                                    <tr>
                                        <td className="h-3">DESCRIPTION</td>
                                        <td className="text-[8px] font-medium flex">:&nbsp;<p className="w-[185px] truncate">P-SHAPE TABLE WOODGRAIN FINISH 180X80</p></td>
                                    </tr>
                                    <tr>
