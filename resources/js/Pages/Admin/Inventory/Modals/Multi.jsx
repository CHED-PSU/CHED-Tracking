...
export default function Assign({ className, clickMultiModal, selectedId}) {
                        ...
                        <div className="pb-16 space-y-3">
                            <div className="flex bg-gray-100 rounded-xl py-5 px-6 gap-3 cursor-default">
                                ...
                                <div className="w-full space-y-2">
                                    <div className="border-b-2 font-semibold pl-[10px] text-xl bg-gray-300 h-8 rounded-md w-full">{loading ? '' :users[selectedPerson - 1].firstname + ' ' + users[selectedPerson - 1].surname}</div>
                                    <div className="border-b-2 font-medium pl-[10px] text-lg bg-gray-200 h-8 rounded-md w-56">{loading ? '' :users[selectedPerson - 1].designation}</div>
                                </div>
                            </div>
                            <form action="">
                                <div className="flex flex-col justify-between">
                                    <label htmlFor="Status" className="text-base font-semibold">Select a User:</label>
                                    <select onChange={personChanger} name="" id="Status" className="w-full rounded-md border border-neutral-500 p-4 outline-none cursor-pointer">
                                ...
                                <div className="flex justify-center mt-[50px]">
                                    <button onClick={confirmHandler} className="w-28 h-10 p-1 rounded-full bg-primary dark:bg-active-icon hover:btn-color-2 text-lightColor-800 font-semibold">
                                        Confirm
                                    </button>
                                </div>
                            </form>
