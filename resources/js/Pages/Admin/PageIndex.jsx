...
export default function Index() {
    ...
    return (
        ...
        <div className="overflow-auto relative w-full h-screen flex bg-[#fafafa] dark:bg-darkColor-900 transition-all duration-150 transform
        lg:min-w-[1903px] lg:min-h-[961px] min-w-[1903px] min-h-[961px]">
            ...
            <div className="relative flex flex-col flex-auto w-auto overflow-auto">
                <nav className="h-fit flex justify-between border-b border-neutral-200 dark:border-neutral-700 2xl:py-5 xl:py-2 py-2 2xl:px-10 xl:px-5 px-5">
                    ...
                    <div className="w-full">
                        {/* Dashboard */}
                        <div
                            className={sidebar === "dashboard" ? "" : "hidden"}
                        >
                            <div className="flex">
                        ...
                        {/* Pending Req */}
                        <div className={sidebar === "pending" ? "" : "hidden"}>
                            <div className="flex">
                                <div className="flex h-12 items-center 2xl:text-xl xl:text-lg text-lg font-bold text-neutral-700 dark:text-neutral-200 cursor-default">
                                    Pending Requests
                                </div>
                        ...
                        {/* Return Items */}
                        <div className={sidebar === "return" ? "" : "hidden"}>
                            <div className="flex">
                                <div className="flex h-12 items-center 2xl:text-xl xl:text-lg text-lg font-bold text-neutral-700 dark:text-neutral-200 cursor-default">
                                    Return Items
                                </div>
                        ...
                        {/* Unserviceable */}
                        <div className={sidebar === "unserv" ? "" : "hidden"}>
                            <div className="flex">
                                <div className="flex h-12 items-center 2xl:text-xl xl:text-lg text-lg font-bold text-neutral-700 dark:text-neutral-200 cursor-default">
                                    Unserviceable
                                </div>
                        ...
                        {/* Forecasting */}
                        <div className={sidebar === "forecast" ? "" : "hidden"}>
                            <div className="flex">
                                <div className="flex h-12 items-center 2xl:text-xl xl:text-lg text-lg font-bold text-neutral-700 dark:text-neutral-200 cursor-default">
                                    Forecasting
                                </div>
                ...
                <div className="h-full flex">
                    ...
                    {sidebar === "dashboard" ? (
                        <Dashboard
                            className={
                                "relative flex w-full h-full transition duration-150 ease-in-out"
                            }
                        />
                    ) : (
                        ""
