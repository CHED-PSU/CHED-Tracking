                    ...
                    <div ref={ref} className="w-[8.27in] p-6">
                        ...
                        <div className="mt-4 mb-2">
                            ...
                            <div className="flex justify-between text-sm">
                                ...
                                <div className="border border-b-0 w-1/4 p-2 text-xs font-medium">
                                    Date:  <font className="font-medium">{loading ? ' ' : info.issued_date}</font>
                                </div>
                            </div>
                                ...
                                <div className="flex gap-7 ml-40">
                                    <div className="">
                                        <div className="flex gap-1 pb-2">
                                            {loading ? ' ' : <input type="radio" name="transferType" id="donation" value="Donation"  checked={info.Type === 'donation' ? true : false} />}
                                            <label for="donation" className="text-black font-medium text-xs">Donation</label>
                                        </div>
                                        <div className="flex gap-1">
                                            {loading ? ' ' : <input type="radio" name="transferType" id="relocate" value="Relocate"  checked={info.Type === 'relocate' ? true : false} />}
                                            <label for="relocate" className="text-black font-medium text-xs">Relocate</label>
                                        </div>
                                    </div>
                                    <div>
                                        <div className="flex gap-1 pb-2">
                                            {loading ? ' ' : <input type="radio" name="transferType" id="reassignment" value="Donation"  checked={loading &&info.Type === 'reassignment' ? true : false} />}
                                            <label for="reassignment" className="text-black font-medium text-xs">Reassignment</label>
                                        </div>
                                        <div className="flex gap-1 items-center">
                                            {loading ? ' ' : <input type="radio" name="transferType" id="others" value="Relocate"  checked={loading &&info.Type === 'others' ? true : false} />}
