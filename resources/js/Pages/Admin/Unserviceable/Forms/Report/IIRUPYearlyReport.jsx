                        ...
                        <div className="mt-4 mb-2">
                            ...
                            >
                                ...
                                <tbody id="slip-table">
                                    ...
                                    <tr>
                                        <td className="text-xs border border-text-gray text-center py-2" colSpan={3}>*nothing follows*</td>
                                        <td className="text-center border border-text-gray"></td>
                                        <td className="text-center border border-text-gray"></td>
                                        <td className="text-center border border-text-gray"></td>
                                        <td className="text-center border border-text-gray"></td>
                                        ...
                                        <td className="text-center border border-text-gray"></td>
                                        <td className="text-center border border-text-gray"></td>
                                        <td colSpan={8} className="text-center border border-text-gray"></td>
