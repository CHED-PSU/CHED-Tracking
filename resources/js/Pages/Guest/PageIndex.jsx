                ...
                <div className="">
                    {
                        ...
                        <button className="flex flex-none justify-center items-center btn-sm my-3 p-3 bg-[#011284] rounded-full text-white 2xl:text-base xl:text-sm text-sm w-full h-12 cursor-pointer">
                            Log In
                        </button>
