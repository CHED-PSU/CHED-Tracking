    ...
    return (
        <div className={props.className}>
            ...
            <div className="absolute w-fit h-fit flex justify-end 2xl:top-20 xl:top-16 top-16 2xl:right-10 xl:right-5 right-5 z-50">
                ...
                >
                    <div className="w-fit h-fit bg-white border border-neutral-200 rounded-xl 2xl:pt-2 xl:pt-0 pt-0 2xl:pb-4 xl:pb-3 pb-3 2xl:px-4 xl:px-3 px-3 space-y-3 shadow-lg">
