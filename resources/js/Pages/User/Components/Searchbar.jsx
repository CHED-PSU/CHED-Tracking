                ...
                <form action="" onSubmit={submitHandler}>
                    <div className="relative h-full flex flex-auto justify-center items-center">
                        <input
                            ...
                            autoComplete="off"
                            aria-label="Search"
                            className="h-10 2xl:pl-6 xl:pl-5 pl-5 pr-14 2xl:text-base xl:text-sm text-sm 2xl:w-96 xl:w-80 w-80 rounded-full outline-none ring-2 ring-white dark:ring-darkColor-900 focus:ring-sky-500 hover:ring-sky-500 dark:focus:ring-sky-500 dark:hover:ring-sky-500 border border-sc bg-[#F5F5F5] dark:bg-darkColor-800 dark:border-darkColor-700 dark:text-white"
                        />
                        <button
                            title="Search"
                            type="submit"
