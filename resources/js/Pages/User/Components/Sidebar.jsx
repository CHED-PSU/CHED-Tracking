...
export default function Sidebar(props) {
    ...
    return (
        <>
            <div className="w-72 sticky top-0 flex flex-none flex-col bg-white dark:bg-darkColor-800 text-center border-r border-neutral-200 shrink-0 z-20 transition-all duration-150 transform">
                {/* Logo */}
                <div
                ...
                <div className="flex-none h-36 flex text-center items-center mx-6">
                    <button
                        ...
                        className="font-semibold 2xl:text-md xl:text-[15px] text-[15px] dark:text-lightColor-800 mx-auto"
                    >
                        Exit
                    </button>
                </div>
